...
Features are defined as modules, that can be disabeld or enabled in the server config, 
...
Commands
- `/roleplay regions apply <pos1> <pos2>` - Sets the region of this item to be between the supplied cordinates
...
this config can be reloaded while the server is running, and icons can be assigned in the config aswell
